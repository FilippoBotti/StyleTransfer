...
if __name__ == '__main__':
    ...
    parser.add_argument('--decoder_sota_path', type=str, default='/home/filippo/projects/StyTR-2/checkpoints/basic_pretrained/decoder_iter_160000.pth')
    parser.add_argument('--Trans_sota_path', type=str, default='/home/filippo/projects/StyTR-2/checkpoints/basic_pretrained/transformer_iter_160000.pth')
    parser.add_argument('--embedding_sota_path', type=str, default='/home/filippo/projects/StyTR-2/checkpoints/basic_pretrained/embedding_iter_160000.pth')
    ...
    parser.add_argument('--use_mamba_enc', action='store_true') 
    parser.add_argument('--use_mamba_dec', action='store_true') 
    parser.add_argument('--c_style', action='store_true') 
    parser.add_argument('--c_input', action='store_true') 
    parser.add_argument('--model_name', type=str, default='sty_tr2')
