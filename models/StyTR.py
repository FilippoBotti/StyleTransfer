...
class StyTrans(nn.Module):
    ...
    def forward(self, samples_c: NestedTensor,samples_s: NestedTensor):
        ...
        #loss_c_s = self.calc_content_loss(normal(Ics_feats[-1]), normal(style_feats[-1]))+self.calc_content_loss(normal(Ics_feats[-2]), normal(style_feats[-2]))
        # Style loss
        ...
        return Ics,  loss_c, loss_s, loss_lambda1, loss_lambda2, Icc, Iss#, loss_c_s   #train
        # return Ics    #test 