...
class Transformer(nn.Module):
    ...
    def __init__(self, d_model=512, nhead=8, num_encoder_layers=3,
        ...
        self.encoder_c = TransformerEncoder(encoder_layer, num_encoder_layers, encoder_norm, args=self.args)
        self.encoder_s = TransformerEncoder(encoder_layer, num_encoder_layers, encoder_norm, args=self.args)
